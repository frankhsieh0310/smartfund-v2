...
| 1 | Stocks | Financial Statements | 3.1417% | DATA_ONLY | Revenue coverage; EPS coverage; Cash coverage; Debt coverage; Assets/Liabilities/Equity coverage; Cash-flow coverage; Incremental filing scheduler; Production validation | 2543/80944 stocks; 3,854,104 canonical facts |
...
| 2 | ETF | Daily Price | 41.7570% | PARTIAL_PRODUCTION | Complete the resumable Global ETF universe; Regional Daily counts are not isolated | PAUSED |
