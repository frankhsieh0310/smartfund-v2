...
| --- | --- | --- | --- | --- | --- | --- |
| Stock split / ratio / effective date | No dedicated table | 5 symbols / 55 `yahoo.event.splitRatio` facts | Historical + incremental pilot | Yahoo Chart | Prototype | Daily incremental |
| Cash dividend / amount / ex-date | No dedicated table | 5 symbols / 309 `yahoo.event.cashDividend` facts | Historical + incremental pilot | Yahoo Chart | Prototype | Daily incremental |
...
No dedicated event schema, migration, or new event worker was added. The existing Yahoo financial lifecycle runner is the verified five-symbol pilot.
