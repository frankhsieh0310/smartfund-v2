...
export type Etf = {
  ...
  export const ETF_LIST: Etf[] = [
    // ---- 台股 ETF：市值型 ----
    { code: "0050", name: "元大台灣50", region: "台灣", sector: "市值型", expenseRatio: 0.43, dividendYield: 2.8, aum: 2195, return1y: 21.6 },
    { code: "0051", name: "元大中型100", region: "台灣", sector: "市值型", expenseRatio: 0.42, dividendYield: 2.4, aum: 36, return1y: 18.4 },
    { code: "006208", name: "富邦台50", region: "台灣", sector: "市值型", expenseRatio: 0.35, dividendYield: 2.7, aum: 1605, return1y: 21.4 },
    { code: "00922", name: "國泰台灣領袖50", region: "台灣", sector: "市值型", expenseRatio: 0.45, dividendYield: 2.5, aum: 180, return1y: 20.8 },
    { code: "006201", name: "元大富櫃50", region: "台灣", sector: "市值型", expenseRatio: 0.45, dividendYield: 1.8, aum: 28, return1y: 15.2 },
    { code: "00830", name: "國泰費城半導體", region: "台灣", sector: "半導體", expenseRatio: 0.45, dividendYield: 0.8, aum: 85, return1y: 38.4 },
    { code: "00881", name: "國泰台灣5G+", region: "台灣", sector: "科技", expenseRatio: 0.45, dividendYield: 2.4, aum: 120, return1y: 22.6 },
    { code: "00891", name: "中信關鍵半導體", region: "台灣", sector: "半導體", expenseRatio: 0.45, dividendYield: 1.2, aum: 95, return1y: 36.8 },
    { code: "00904", name: "新光臺灣半導體30", region: "台灣", sector: "半導體", expenseRatio: 0.45, dividendYield: 1.0, aum: 42, return1y: 34.2 },
    { code: "00913", name: "兆豐台灣晶圓製造ETF", region: "台灣", sector: "半導體", expenseRatio: 0.45, dividendYield: 1.4, aum: 38, return1y: 32.8 },
    { code: "00928", name: "中信上櫃ESG30", region: "台灣", sector: "ESG", expenseRatio: 0.45, dividendYield: 2.2, aum: 32, return1y: 18.6 },
    { code: "00943", name: "兆豐電子高息等權", region: "台灣", sector: "高股息", expenseRatio: 0.45, dividendYield: 5.8, aum: 28, return1y: 14.2 },
    { code: "00947", name: "台新臺灣IC設計動能ETF", region: "台灣", sector: "半導體", expenseRatio: 0.45, dividendYield: 0.8, aum: 22, return1y: 28.4 },
  
    // ---- 台股 ETF：高股息 ----
    { code: "0056", name: "元大高股息", region: "台灣", sector: "高股息", expenseRatio: 0.66, dividendYield: 6.2, aum: 680, return1y: 12.4 },
    { code: "00878", name: "國泰永續高股息", region: "台灣", sector: "高股息", expenseRatio: 0.59, dividendYield: 5.8, aum: 920, return1y: 13.7 },
    { code: "00919", name: "群益台灣精選高息", region: "台灣", sector: "高股息", expenseRatio: 0.55, dividendYield: 8.4, aum: 1850, return1y: 14.2 },
    { code: "00929", name: "復華台灣科技優息", region: "台灣", sector: "高股息", expenseRatio: 0.55, dividendYield: 8.8, aum: 980, return1y: 13.8 },
    { code: "00713", name: "元大台灣高息低波", region: "台灣", sector: "高股息", expenseRatio: 0.60, dividendYield: 5.4, aum: 240, return1y: 11.6 },
    { code: "00900", name: "富邦特選高股息30", region: "台灣", sector: "高股息", expenseRatio: 0.55, dividendYield: 7.2, aum: 185, return1y: 12.8 },
    { code: "00907", name: "永豐優息存股", region: "台灣", sector: "高股息", expenseRatio: 0.55, dividendYield: 6.8, aum: 120, return1y: 11.4 },
    { code: "00915", name: "凱基優選高股息30", region: "台灣", sector: "高股息", expenseRatio: 0.55, dividendYield: 7.4, aum: 145, return1y: 13.2 },
    { code: "00918", name: "大華優利高填息30", region: "台灣", sector: "高股息", expenseRatio: 0.55, dividendYield: 6.6, aum: 88, return1y: 12.6 },
    { code: "00730", name: "富邦臺灣優質高息", region: "台灣", sector: "高股息", expenseRatio: 0.55, dividendYield: 5.8, aum: 65, return1y: 11.8 },
    { code: "00934", name: "中信成長高股息", region: "台灣", sector: "高股息", expenseRatio: 0.55, dividendYield: 7.6, aum: 320, return1y: 13.4 },
    { code: "00936", name: "台新永續高息中小型ETF", region: "台灣", sector: "高股息", expenseRatio: 0.55, dividendYield: 7.8, aum: 95, return1y: 14.6 },
    { code: "00961", name: "FT臺灣永續高息", region: "台灣", sector: "高股息", expenseRatio: 0.55, dividendYield: 6.4, aum: 48, return1y: 12.2 },
  
    // ---- 台股 ETF：ESG/永續 ----
    { code: "00888", name: "永豐台灣ESG", region: "台灣", sector: "ESG", expenseRatio: 0.45, dividendYield: 2.8, aum: 42, return1y: 19.8 },
    { code: "00850", name: "元大臺灣ESG永續", region: "台灣", sector: "ESG", expenseRatio: 0.45, dividendYield: 2.4, aum: 68, return1y: 18.4 },
    { code: "00永續-1", name: "富邦公司治理", region: "台灣", sector: "ESG", expenseRatio: 0.45, dividendYield: 2.6, aum: 55, return1y: 17.8 },
    { code: "00927", name: "群益半導體收益", region: "台灣", sector: "半導體", expenseRatio: 0.45, dividendYield: 4.2, aum: 68, return1y: 28.6 },
  
    // ---- 台股 ETF：科技/產業 ----
    { code: "0052", name: "富邦科技", region: "台灣", sector: "科技", expenseRatio: 0.38, dividendYield: 1.8, aum: 1605, return1y: 28.4 },
    { code: "0053", name: "元大電子", region: "台灣", sector: "科技", expenseRatio: 0.45, dividendYield: 1.6, aum: 14, return1y: 24.8 },
    { code: "0055", name: "元大MSCI金融", region: "台灣", sector: "金融", expenseRatio: 0.45, dividendYield: 3.8, aum: 18, return1y: 14.2 },
  
    // ---- 台股 ETF：主動式 ----
    { code: "00400A", name: "主動國泰動能高息", region: "台灣", sector: "主動式", expenseRatio: 0.95, dividendYield: 6.8, aum: 225, return1y: 15.4 },
    { code: "00401A", name: "主動摩根台灣鑫收", region: "台灣", sector: "主動式", expenseRatio: 0.95, dividendYield: 5.8, aum: 35, return1y: 13.8 },
    { code: "00403A", name: "主動統一升級50", region: "台灣", sector: "主動式", expenseRatio: 0.95, dividendYield: 2.4, aum: 1752, return1y: 22.4 },
    { code: "00404A", name: "主動聯博動能50", region: "台灣", sector: "主動式", expenseRatio: 0.95, dividendYield: 2.2, aum: 31, return1y: 21.8 },
    { code: "00405A", name: "主動富邦台灣龍耀", region: "台灣", sector: "主動式", expenseRatio: 0.95, dividendYield: 2.6, aum: 233, return1y: 20.4 },
    { code: "00406A", name: "主動中信台灣收益", region: "台灣", sector: "主動式", expenseRatio: 0.95, dividendYield: 5.4, aum: 72, return1y: 14.8 },
  
    // ---- 台灣債券 ETF ----
    { code: "00679B", name: "元大美債20年", region: "美國", sector: "債券", expenseRatio: 0.15, dividendYield: 3.8, aum: 95, return1y: -1.8 },
    { code: "00696B", name: "富邦美債7-10", region: "美國", sector: "債券", expenseRatio: 0.15, dividendYield: 3.4, aum: 42, return1y: 0.8 },
    { code: "00720B", name: "元大投資級公司債", region: "美國", sector: "債券", expenseRatio: 0.20, dividendYield: 4.2, aum: 65, return1y: 2.4 },
    { code: "00725B", name: "國泰投資級公司債", region: "美國", sector: "債券", expenseRatio: 0.20, dividendYield: 4.0, aum: 48, return1y: 2.2 },
    { code: "00740B", name: "元大美債7-10", region: "美國", sector: "債券", expenseRatio: 0.15, dividendYield: 3.6, aum: 38, return1y: 1.2 },
    { code: "00751B", name: "元大AAA至A公司債", region: "美國", sector: "債券", expenseRatio: 0.20, dividendYield: 3.8, aum: 32, return1y: 2.0 },
    { code: "00761B", name: "元大美債1-3", region: "美國", sector: "債券", expenseRatio: 0.15, dividendYield: 4.8, aum: 28, return1y: 4.2 },
    { code: "00772B", name: "中信高評級公司債", region: "全球", sector: "債券", expenseRatio: 0.20, dividendYield: 4.4, aum: 55, return1y: 2.8 },
    { code: "00779B", name: "凱基美債25年以上", region: "美國", sector: "債券", expenseRatio: 0.20, dividendYield: 3.6, aum: 22, return1y: -2.4 },
    ...
    { code: "SPY", name: "SPDR S&P 500 ETF Trust", region: "美國", sector: "市值型", expenseRatio: 0.09, dividendYield: 1.2, aum: 5800, return1y: 24.0 },
    { code: "IVV", name: "iShares Core S&P 500 ETF", region: "美國", sector: "市值型", expenseRatio: 0.03, dividendYield: 1.2, aum: 4800, return1y: 24.1 },
    ...
    { code: "QQQM", name: "Invesco NASDAQ 100 ETF", region: "美國", sector: "科技", expenseRatio: 0.15, dividendYield: 0.6, aum: 320, return1y: 29.4 },
