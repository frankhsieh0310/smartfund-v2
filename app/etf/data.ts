...
export type Etf = {
    ...
    dividendFreq: string;      // 配息頻率：月配 / 季配 / 半年配 / 年配 / 不配息
    returnYTD: number;         // 今年以來績效 %
    return1m: number;          // 近1個月績效 %
    return3m: number;          // 近3個月績效 %
    return6m: number;          // 近6個月績效 %
    return1y: number;          // 近1年績效 %
    return3y: number;          // 近3年績效 %
    volatility: number;        // 年化波動度 %
  };
  
  // ── 輔助：根據 sector / dividendYield 推算配息頻率 ──────────────────
  ...
  const RAW = [
    ...
    { code: "00904",  name: "新光臺灣半導體30",        region: "台灣", sector: "半導體",   dividendYield: 1.0,  return1y: 34.2 },
    { code: "00913",  name: "兆豐台灣晶圓製造ETF",    region: "台灣", sector: "半導體",   dividendYield: 1.4,  return1y: 32.8 },
    { code: "00928",  name: "中信上櫃ESG30",           region: "台灣", sector: "ESG",      dividendYield: 2.2,  return1y: 18.6 },
    { code: "00943",  name: "兆豐電子高息等權",        region: "台灣", sector: "高股息",   dividendYield: 5.8,  return1y: 14.2 },
    { code: "00947",  name: "台新臺灣IC設計動能ETF",  region: "台灣", sector: "半導體",   dividendYield: 0.8,  return1y: 28.4 },
    // ---- 高股息 ----
    ...
    { code: "00730",  name: "富邦臺灣優質高息",        region: "台灣", sector: "高股息",   dividendYield: 5.8,  return1y: 11.8 },
    ...
    { code: "00961",  name: "FT臺灣永續高息",          region: "台灣", sector: "高股息",   dividendYield: 6.4,  return1y: 12.2 },
    // ---- ESG ----
    { code: "00888",  name: "永豐台灣ESG",             region: "台灣", sector: "ESG",      dividendYield: 2.8,  return1y: 19.8 },
    { code: "00850",  name: "元大臺灣ESG永續",         region: "台灣", sector: "ESG",      dividendYield: 2.4,  return1y: 18.4 },
    { code: "00永續-1",name: "富邦公司治理",           region: "台灣", sector: "ESG",      dividendYield: 2.6,  return1y: 17.8 },
    ...
    { code: "00401A", name: "主動摩根台灣鑫收",        region: "台灣", sector: "主動式",   dividendYield: 5.8,  return1y: 13.8 },
    ...
    { code: "00405A", name: "主動富邦台灣龍耀",        region: "台灣", sector: "主動式",   dividendYield: 2.6,  return1y: 20.4 },
  ...
  export const ETF_LIST: Etf[] = RAW.map(r => ({
    ...
    dividendPerUnit: r.dividendYield > 0
      ? parseFloat((r.dividendYield * 0.18).toFixed(2))   // 示意：殖利率 × 單位淨值估算
      : 0,
    dividendYield: r.dividendYield,
    dividendFreq: freq(r.sector, r.dividendYield),
    returnYTD:  parseFloat((r.return1y * 0.52).toFixed(1)),  // 示意：約年度一半
